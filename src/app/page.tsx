    ...
    <>
      <section className="bg-hero-pattern bg-no-repeat bg-center mt-5 xl:mt-20 xl:bg-left">
        ...
        <div className="flex flex-col gap-5 mt-12 pb-5 text-center xl:text-right">
          ...
          <p>
            هر جای مسیر برنامه‌نویسی که باشی، با هم‌راهی استادهای
            باتجربه‌ی کلاسبن می‌تونی بدون محدودیت به قله‌های بالاتر
            صعود کنی. کا همیشه هواتو داریم.
          </p>
          <Image src="/images/frameworks.png" width={412} height={39} alt=""
